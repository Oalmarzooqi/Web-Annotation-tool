...
export function ProjectAnnotatePage() {
  ...
  const savePayload = useMemo(
    () => JSON.stringify({ a: history.present.annotationsBySlice, l: labels }),
    [history.present.annotationsBySlice, labels],
  );
  ...
  const saveProjectToDb = useCallback(
    ...
    [project, selectedFileName, history.present.annotationsBySlice, labels, savePayload, showToast],
  );
